...
class AuthControllerTest {
    ...
    @Test
    void accessApiWithoutTokenRejected() throws Exception {
    ...
    @Test
    void accessApiWithInvalidTokenRejected() throws Exception {
        mockMvc.perform(get("/api/jd").header("Authorization", "Bearer invalid-token"))
                .andExpect(status().isUnauthorized())
                .andExpect(jsonPath("$.code").value(401));
    }
